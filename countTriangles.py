...
def countDistinctTriangles(arr):
  ...
  for triangle in arr:
     # Sort the sides of the triangle to get a unique representation
      sorted_triangle = tuple(sorted(triangle))
      # Add the sorted tuple to the set
      distinct_triangles.add(sorted_triangle)
    
  # The number of distinct triangles is the size of the set
